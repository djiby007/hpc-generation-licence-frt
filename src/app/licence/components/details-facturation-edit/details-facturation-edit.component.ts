...
@Component({
  selector: 'app-details-facturation-edit',
  templateUrl: './details-facturation-edit.component.html',
  styleUrls: ['./details-facturation-edit.component.css']
})
export class DetailsFacturationEditComponent implements OnInit {
